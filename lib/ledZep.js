...
var LedZepSong = function (_Song) {
  ...
  function LedZepSong(song) {
    _classCallCheck(this, LedZepSong);

    return _possibleConstructorReturn(this, (LedZepSong.__proto__ || Object.getPrototypeOf(LedZepSong)).call(this, "Led Zep", song));
  }

  return LedZepSong;
}(_talkingHead.Song);

//Editing only the constructor and super methods, 
